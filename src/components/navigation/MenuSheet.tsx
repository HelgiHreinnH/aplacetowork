...
const MenuSheet = () => {
  return (
    <Sheet>
      ...
      <SheetContent 
        side="bottom" 
        className="w-[90%] max-w-md mx-auto left-1/2 -translate-x-1/2 h-[80vh] rounded-t-3xl border-t-0 mt-4 pb-24"
      >
        <nav className="flex flex-col gap-4 mt-8 animate-slide-up">
